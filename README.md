...
- [Table of Contents](#table-of-contents)
    - [P3. Prepare Data for ETL](#p3-prepare-data-for-etl)
- [Smart Sales](#smart-sales)
  - [Schema](#schema)
    - [Customers Table](#customers-table)
    - [Product Table](#product-table)
    - [Sales Table](#sales-table)
  - [Stub in new function definitions after global constants](#stub-in-new-function-definitions-after-global-constants)
- [Define ETL helper functions here.....](#define-etl-helper-functions-here)
    - [Complete the load data function definition](#complete-the-load-data-function-definition)
    - [Edit delete\_existing\_records function](#edit-delete_existing_records-function)
    - [Complete Insert Function Definition (For the First Dimension Table)](#complete-insert-function-definition-for-the-first-dimension-table)
    - [Cubing with Python](#cubing-with-python)
- [OLAP Cubing for Low-Performing Products](#olap-cubing-for-low-performing-products)
  - [Features](#features)
  ...
  - [Customization](#customization)
    - [Change Dimensions and Metrics](#change-dimensions-and-metrics)
  - [Version Control](#version-control)
- [OLAP Cubing for Identifying Low-Performing Products](#olap-cubing-for-identifying-low-performing-products)
  - [The Business Goal](#the-business-goal)
  - [Data Source](#data-source)
  - [Tools](#tools)
  - [Workflow \& Logic](#workflow--logic)
    - [1. Defining Dimensions and Metrics](#1-defining-dimensions-and-metrics)
    - [2. Aggregation Logic](#2-aggregation-logic)
    - [3. Threshold Filtering](#3-threshold-filtering)
  ...
  - [Challenges](#challenges)
    - [Challenge 1: Handling Missing Data](#challenge-1-handling-missing-data)
    - [Challenge 2: Ambiguous Metrics](#challenge-2-ambiguous-metrics)
    - [Challenge 3: Output Usability](#challenge-3-output-usability)
