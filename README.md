...
1. [Project Start & Planning](#smart-store-marco)
   1.1. [Project Setup Instructions](#project-setup-instructions)
   
      - 1.1.1. [Create Local Project Virtual Environment (One-Time Task)](#create-local-project-virtual-environment-one-time-task)
      - 1.1.2. [Activate Virtual Environment (Every Time we Open a Terminal)](#activate-virtual-environment-every-time-we-open-a-terminal-to-work-on-the-project)
      - 1.1.3. [Install Requirements](#install-requirements)
      - 1.1.4. [Create utils/logger.py](#create-utilsloggerpy)
      - 1.1.5. [Create scripts/data_prep.py](#create-scriptsdatapreppy)
      - 1.1.6. [Run Python Script](#run-python-script)
      - 1.1.7. [Git add-commit-push Your Work Back to GitHub Project Repository](#git-add-commit-push-your-work-back-to-github-project-repository)

2. [Prepare Data for ETL](#p3-prepare-data-for-etl)
   2.1. [Error Handling and Fixes](#error-handling-and-fixes)
   2.2. [Functionality and Additions](#functionality-and-additions)
   2.3. [Module Not Found Error Fix](#utils-module-not-found-error-fix)

3. [Smart Sales Schema](#smart-sales)
   3.1. [Customers Table](#customers-table)
   3.2. [Product Table](#product-table)
   3.3. [Sales Table](#sales-table)

4. [ETL Helper Functions](#stub-in-new-function-definitions-after-global-constants)
   4.1. [Insert Function Definitions](#insert-function-definitions)
   4.2. [Load Data Function](#load-data-function)
   4.3. [Delete Existing Records Function](#delete-existing-records-function)
   4.4. [Insert Data into Customer Table](#insert-customers)

5. [Cubing with Python](#cubing-with-python)
   5.1. [Error Resolution](#error-resolution)
   5.2. [Project Path Solution](#project-path-solution)

6. [OLAP Cubing for Low-Performing Products](#olap-cubing-for-low-performing-products)
   6.1. [Features](#features)
   6.2. [Requirements](#requirements)
   6.3. [Setup Instructions](#setup-instructions)
      - 6.3.1. [Clone Repository](#clone-repository)
      - 6.3.2. [Install Dependencies](#install-dependencies)
      - 6.3.3. [Prepare Data Warehouse](#prepare-data-warehouse)
      - 6.3.4. [Directory Structure](#directory-structure)
   6.4. [Script Overview](#script-overview)
      - 6.4.1. [Ingest Sales Data](#ingest-sales-data)
      - 6.4.2. [Add Time-Based Dimensions](#add-time-based-dimensions)
      - 6.4.3. [Create OLAP Cube](#create-olap-cube)
      - 6.4.4. [Identify Low-Performing Products](#identify-low-performing-products)
      - 6.4.5. [Sort by Sales and Count](#sort-by-sales-and-count)
      - 6.4.6. [Save Results](#save-results)
   6.5. [Example Output](#example-output)
   6.6. [Customization](#customization)
      - 6.6.1. [Change Dimensions and Metrics](#change-dimensions-and-metrics)
   6.7. [Version Control](#version-control)

7. [OLAP Cubing for Identifying Low-Performing Products](#olap-cubing-for-identifying-low-performing-products)
   7.1. [Business Goal](#business-goal)
   7.2. [Data Source](#data-source)
   7.3. [Tools](#tools)
   7.4. [Workflow & Logic](#workflow--logic)
      - 7.4.1. [Defining Dimensions and Metrics](#defining-dimensions-and-metrics)
      - 7.4.2. [Aggregation Logic](#aggregation-logic)
      - 7.4.3. [Threshold Filtering](#threshold-filtering)
      - 7.4.4. [Sorting and Counting](#sorting-and-counting)
   7.5. [Results](#results)
      - 7.5.1. [Insights](#insights)
      - 7.5.2. [Visualization](#visualization)
      - 7.5.3. [Suggested Actions](#suggested-actions)
   7.6. [Challenges](#challenges)
      - 7.6.1. [Handling Missing Data](#handling-missing-data)
      - 7.6.2. [Ambiguous Metrics](#ambiguous-metrics)
