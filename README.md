...
1. [Project Start & Planning](#smart-store-marco)
   1.1. [Project Setup Instructions](#project-setup-instructions)
      ...
      1.1.7. [Next Step](#next-step)

2. [Data Collection & Preprocessing](#data-collection--preprocessing)
   2.1. [Import Libraries](#import-libraries)
      2.1.1. [Install Pandas and Requests](#install-pandas-and-requests)
      2.1.2. [Import Libraries in Python](#import-libraries-in-python)
   2.2. [Data Extraction from API](#data-extraction-from-api)
      2.2.1. [Set up API URL and Parameters](#set-up-api-url-and-parameters)
      2.2.2. [Fetch Data from API](#fetch-data-from-api)
   2.3. [Data Preprocessing](#data-preprocessing)
      2.3.1. [Handle Missing Data](#handle-missing-data)
      2.3.2. [Clean Data](#clean-data)
   2.4. [Save Preprocessed Data](#save-preprocessed-data)

3. [Feature Engineering](#feature-engineering)
   3.1. [Define Features](#define-features)
      3.1.1. [Create Numeric Features](#create-numeric-features)
      3.1.2. [Create Categorical Features](#create-categorical-features)
   3.2. [Normalize Data](#normalize-data)

4. [Model Development](#model-development)
   4.1. [Split Data](#split-data)
      4.1.1. [Train-Test Split](#train-test-split)
      4.1.2. [Cross-Validation](#cross-validation)
   4.2. [Train Model](#train-model)
      4.2.1. [Choose Model Type](#choose-model-type)
      4.2.2. [Train with Selected Model](#train-with-selected-model)
   4.3. [Evaluate Model](#evaluate-model)
      4.3.1. [Metrics](#metrics)
      4.3.2. [Validation](#validation)
   4.4. [Save Model](#save-model)

5. [Model Deployment](#model-deployment)
   5.1. [Prepare for Deployment](#prepare-for-deployment)
      5.1.1. [Create Deployment Scripts](#create-deployment-scripts)
      5.1.2. [Set Up Deployment Environment](#set-up-deployment-environment)
   5.2. [Deploy Model](#deploy-model)
      5.2.1. [Integrate with Web Framework](#integrate-with-web-framework)
      5.2.2. [Test Deployment](#test-deployment)

6. [Monitoring & Maintenance](#monitoring--maintenance)
   6.1. [Monitor Model](#monitor-model)
      6.1.1. [Set Up Monitoring](#set-up-monitoring)
      6.1.2. [Track Performance](#track-performance)
   6.2. [Model Updates](#model-updates)
      6.2.1. [Re-train Model](#re-train-model)
      6.2.2. [Model Versioning](#model-versioning)

7. [Finalizing & Documentation](#finalizing--documentation)
   7.1. [Write Documentation](#write-documentation)
      7.1.1. [Document Code](#document-code)
      7.1.2. [Create User Guides](#create-user-guides)
   7.2. [Final Checks](#final-checks)
      7.2.1. [Code Review](#code-review)
      7.2.2. [Final Testing](#final-testing)
