...
def main():
    ...
    sales_df["SaleDate"] = pd.to_datetime(sales_df["SaleDate"], errors='coerce')  # Ensure invalid dates are handled

    # Step 3: Add additional columns for time-based dimensions
    sales_df["DayOfWeek"] = sales_df["SaleDate"].dt.day_name()  # This should now work
    ...
    # Step 6: Save the cube to a CSV file
